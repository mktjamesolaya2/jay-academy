...
// Fio a Fio Realista — servida no MESMO slug do site WordPress
// (jayacademy.com.br/fio-a-fio-realista-by-james-olaya) porque o portal vai
// substituir o site em breve e as URLs precisam bater. Os slugs antigos
// (/metodo-fio-a-fio-by-james-olaya e /fio-a-fio-realista) redirecionam pra cá.
...
export async function GET(req: Request) {
  const raw = await readFile(
    path.join(process.cwd(), "lp-html", "fio-a-fio-realista-by-james-olaya.html"),
    "utf8"
  );
