...
### 🏛️ A estrutura emenda no fechamento (20/08)

James: *"acho q pode emendar nessa (...) a gente faz uma transiçãozinha legal
nas duas pra parecer a mesma, mas passar sentidos diferentes"*.

São **duas dobras dentro de uma seção**, com **uma foto atravessando as duas**.
Em cima ela aparece — o espaço é o assunto. Descendo, morre no preto e sobra o
convite.

⚠️ **A transição é a luz acabando**, não uma borda entre seções: o véu é UM só,
vertical, com cinco paradas. Dois véus, um por bloco, deixariam uma emenda
visível bem no meio.

O texto da estrutura fica à **direita** — a única dobra da página com o texto
desse lado. É o que faz a leitura virar antes do convite.

⚠️ A frase original falava em *"processo de aprendizagem"*: é texto da **escola**,
não da clínica. Quem lê esta página veio se tratar, não estudar.
